 ...
 *
 * This is functionally similar to `/ailment remove` but uses ilike lookup
 * and disambiguates on multiple matches.
 */
...
const command: Command = {
  data: new SlashCommandBuilder()
    .setName('heal')
    .setDescription('Cure (resolve) an active ailment on a player')
  ...
  async execute(interaction: ChatInputCommandInteraction): Promise<void> {
    ...
    // ilike-style lookup against the JSONB array
